function h = func_CalcBeamCoupling_h(VoltagesFD, inputsignalsFD)
...
% :param inputsignalsFD: Matrix containing FD port signals (N-by-M).
% :type  inputsignalsFD: complex double
%
% :returns: h (N-by-M)

h = VoltagesFD./inputsignalsFD ;
